/**
 * Heuristic optimizations for diff algorithms.
 * Ported from VS Code's heuristicSequenceOptimizations.
 */
import { OffsetRange } from './offsetRange';
import { type ISequence, OffsetPair, SequenceDiff } from './diffAlgorithm';
import type { LineSequence } from './lineSequence';
import type { LinesSliceCharSequence } from './charSequence';
import { forEachWithNeighbors } from './utils';

/**
 * Optimizes sequence diffs by joining and shifting them to better positions.
 */
...
/**
 * Joins adjacent sequence diffs by shifting them to find better positions.
...
/**
 * Shifts diffs to better positions based on boundary scores.
 */
...
/**
 * Removes short matches between diffs.
 */
...
/**
 * Extends diffs to entire words if appropriate.
 */
export function extendDiffsToEntireWordIfAppropriate(
  ...
  function scanWord(pair: OffsetPair, equalMapping: SequenceDiff): void {
    ...
    // Check if words touch the next equal mappings
...
/**
 * Removes very short matching lines between diffs.
 */
...
/**
 * Removes very short matching text between long diffs.
 */
